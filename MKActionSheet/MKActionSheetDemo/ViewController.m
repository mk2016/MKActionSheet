...
//        [sheet showWithDelegate:self];
        ...
        MKActionSheet *sheet = [[MKActionSheet alloc] initWithTitle:@"create with models array" modelArray:self.modelArray titleKey:@"titleStr" destructiveButtonIndex:2];
        [sheet showWithBlock:^(MKActionSheet *actionSheet, NSInteger buttonIndex) {
            NSLog(@"----------------------");
            NSLog(@"buttonIndex:%ld",(long)buttonIndex);
        ...
        MKActionSheet *sheet = [[MKActionSheet alloc] initWithTitle:@"create with models array" modelArray:self.modelArray titleKey:@"titleStr" destructiveButtonIndex:3];
        ...
        MKActionSheet *sheet = [[MKActionSheet alloc] initWithTitle:@"create with models array" modelArray:self.dicArray titleKey:@"titleStr" destructiveButtonIndex:3];
        sheet.isNeedCancelButton = YES;
...
- (void)actionSheet:(MKActionSheet *)actionSheet didClickButtonAtIndex:(NSInteger)buttonIndex selectModel:(InfoModel *)obj{
